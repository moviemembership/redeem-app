...
@app.route("/fon.png")
def fon_link():
    return redirect("https://github.com/moviemembership/redeem-app/blob/485881a153a2ebc785e524b94f5a7d9fe232b157/fon.png?raw=true")

@app.route("/tv.png")
def tv_link():
    return redirect("https://github.com/moviemembership/redeem-app/blob/main/tv.png?raw=true")

@app.route("/loading.gif")
def loading_link():
    return redirect("https://github.com/moviemembership/redeem-app/blob/main/Loading_icon.gif?raw=true")
